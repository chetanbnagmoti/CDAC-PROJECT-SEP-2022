                            ...
                            <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                                <div class="tab-content">
                                    <div class="tab-pane fade show active pt-3">
                                        ...
                                        { this.flag &&
										<input class="form-control" type="text"  value={this.state.flightNumber} name="flightNumber" readOnly />
                                        }
                                        </div>
                                        <div class="form-group">
									    <h6><span class="form-label">Flying from</span></h6>
                                        { this.flag &&
										<input class="form-control" type="text"  value={this.state.source} name="source" readOnly />
                                        }
                                        </div>
                                        ...
                                        { this.flag &&
										<input class="form-control" type="text" value={this.state.destination} name="destination" readOnly/>
                                        }
                                        </div>
                                        ...
                                        <div class="row">
									        <div class="col-md-12">
                                                ...
                                                { this.flag &&
                                                <input  value={this.state.date} class="form-control"   readOnly/>
                                                }
                                                </div>
									        </div>
								        </div>
