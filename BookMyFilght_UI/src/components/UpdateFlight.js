    ...
    return (
      <div>
        ...
        <div className="container-fluid" style={styling.wrapper}>
          ...
          >
            <h3 className="mb-3" style={styling.heading}>
            ...
            <div className="input-group mb-2 mr-sm-2">
              ...
              <select
                ...
                required
              >
                <option value="Chennai" onClick={this.handleInput}>
                  {this.state.source}
                </option>
                <option value="Delhi" onClick={this.handleInput}>
                  Delhi
                </option>
                <option value="Mumbai" onClick={this.handleInput}>
                  Mumbai
                </option>
                <option value="Kolkata" onClick={this.handleInput}>
                  Kolkata
                </option>
              </select>
            </div>
